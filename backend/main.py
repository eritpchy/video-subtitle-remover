...
class SubtitleRemover:
    ...
    def run(self):
        ...
        if self.hardware_accelerator.has_accelerator():
            ...
            self.append_output(tr['Main']['AcceleratorON'].format(accelerator_name))
        ...
        if self.is_picture:
            ...
            self.append_output(tr['Main']['UseModel'].format(list(tr['InpaintMode'].values())[list(InpaintMode).index(config.inpaintMode.value)]))
